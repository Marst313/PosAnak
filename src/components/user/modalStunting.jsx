...
const ModalStunting = ({ isModalOpen, closeModalstunting }) => {
  return (
    <div
      className={`fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm  ${isModalOpen ? "flex" : "hidden"}`}
    >
