...
const PopUpChatBot = () => {
  ...
  return (
    <>
      <Link to={`/chatbot/${uuid}`} className="fixed bottom-10 right-20 bg-greenPrimary w-24 p-1 text-white h-12 rounded-full flex items-center justify-center animate-bounce hover:animate-none group ">
        Chat Bot
      </Link>

      <div className={`flex items-start gap-2.5 fixed bottom-28 right-32 text-white  transition-all duration-1000 ${guide ? 'opacity-100 max-h-[500px] p-4' : 'opacity-0 max-h-0 p-0'}`}>
