...
const PopUp = ({ message, open, type }) => {
  ...
  return (
    <div className={`overflow-y-auto overflow-x-hidden absolute left-36 top-0 right-0 z-10 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full  bg-white/30 backdrop-blur-sm ${open ? 'flex' : 'hidden'} `}>
        ...
        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <div className="p-4 md:p-5 text-center">
            ...
            <button
              ...
              type="button"
              className={`${
                type === 'success' ? 'bg-green-600 hover:bg-green-800 focus:ring-green-300' : 'bg-red-600 hover:bg-red-800 focus:ring-red-300'
