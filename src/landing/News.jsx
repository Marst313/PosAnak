...
import { gambarImunisasi, gambarAnak, gambarIbuPosyandu } from '../images/landing/';
    ...
    <div className="relative  px-4 sm:px-6  flex xl:px-60 mt-5 gap-3 flex-col pb-40 overflow-x-hidden">
      <div className="flex lg:items-center justify-between flex-col lg:flex-row gap-5">
        <div className="flex flex-col gap-5 lg:w-1/2 ">
          ...
          <img src={gambarIbuPosyandu} alt="gambar ibu check anak" className="rounded-lg h-full" />
        </div>
              ...
              <li className="bg-white p-3 shadow-custom rounded-xl flex gap-5">
                ...
                <div>
                  <div className="flex items-center gap-3">
                    <img src={calender} alt="logo kalender" />
                  ...
                  <p className="text-xs font-light mt-3 line-clamp-4">
                    Posyandu, atau Pos Pelayanan Terpadu, berperan penting dalam pemantauan dan pemeliharaan kesehatan anak. Salah satu aspek krusial dari peran Posyandu adalah memberikan informasi dan data terkait pertumbuhan anak kepada
                    ibu dan pengasuh. Pemantauan pertumbuhan anak menjadi sangat penting karena memberikan indikasi kesehatan secara keseluruhan dan dapat mendeteksi dini potensi masalah kesehatan.
                  </p>
                </div>
              </li>
            </Link>
        ...
        <ul className="mt-5 lg:grid-cols-3 grid mb-5 gap-5 ">
          <Link to={`/berita/1`}>
            <li className="gap-3 flex flex-col bg-white p-5 rounded-lg  ">
              <img src={gambarIbuPosyandu} alt="gambar ibu check anak" className="w-[361px] h-[157px] object-none rounded-lg" />
              ...
              <h3 className="line-clamp-2 font-medium text-sm">Pemantauan Tumbuh Kembang Anak</h3>
