  ...
  return (
    ...
    >
      <div className="xl:px-48 mt-28 pb-20 lg:pb-0">
        ...
        <p className="max-w-xl font-light mt-5 text-justify">
        ...
        <ul className="bg-white/60 backdrop-blur-sm px-10 py-5 mt-5 mb-2 flex gap-20 w-fit h-fit flex-col lg:flex-row">
