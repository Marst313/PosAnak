        ...
        <div className="self-start lg:self-center w-full lg:w-1/2">
          ...
          <form className="mt-5 w-full" onSubmit={handleSubmit}>
            <div className="mb-5">
              <label
                htmlFor="email"
                className="block mb-2 text-sm  text-darkGreen font-light "
              >
                Email
              </label>
              <input
            ...
            <div className="mb-5">
              <label
                htmlFor="password"
                className="block mb-2 text-sm font-light text-darkGreen dark:text-white"
              >
                Kata Sandi
              </label>
              <input
            ...
            <div className="w-40 lg:w-full lg:flex items-center justify-between">
              <button
                type="submit"
                className="text-white bg-greenPrimary  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-lg px-3 py-2 text-center flex items-center gap-5 pl-7"
              >
                Masuk
