  ...
  return (
    ...
    mt-5 lg:mt-0 pt-10 flex flex-col  lg:items-start justify-between\\\ mb-10"
        >
          ...
          <div className="flex flex-col lg:flex-row items-center mt-10 gap-10">
            <img
              src={profile}
              alt="image"
              className="rounded-full p-1 border border-lightGreen"
            />
          ...
          <div className="mt-5 flex justify-between gap-5">
            <div className="flex flex-col w-full">
              ...
              <input
                ...
                className="rounded-xl focus:ring-0 border-grey mt-2"
          ...
          <button
            type="button"
            className="mx-auto mt-10 bg-lightGreen text-white px-10 py-2 rounded-full border hover:bg-white hover:border-greenPrimary hover:text-greenPrimary transition-all duration-500"
       ...
       mt-5 lg:mt-0 pt-10 lg:flex  items-start justify-between mb-10"
          >
            <h1 className="text-2xl font-semibold text-center lg:text-start lg:mt-0">
              Informasi Profile
            </h1>
            ...
            <img
              src={profile}
              alt="hero image"
              className="rounded-full p-1 border border-lightGreen w-56 h-56 mt-10 lg:mt-16"
            />
            <button
              type="button"
