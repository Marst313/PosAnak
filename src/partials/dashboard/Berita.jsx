  ...
  return (
    <div className=" p-5 flex flex-col float-left gap-5  2xl:w-2/3 rounded-3xl h-fit bg-white  mt-5">
      ...
      <ul className="flex gap-3 flex-wrap">
        <li className="bg-white flex-1 border-grey rounded-lg p-2 border max-w-xs">
          <div className="flex flex-col gap-2 ">
            <img src={BeritaImg} alt="gambar berita" className="rounded-md" />
            <div className="flex items-center gap-2">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 512 512">
                <path fill="none" stroke="#036346" stroke-miterlimit="10" stroke-width="32" d="M256 64C150 64 64 150 64 256s86 192 192 192s192-86 192-192S362 64 256 64Z" />
                <path fill="none" stroke="#036346" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M256 128v144h96" />
              </svg>
